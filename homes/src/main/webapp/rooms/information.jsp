        ...
        <% if (reviews != null && !reviews.isEmpty()) { %>
            <% for (ReviewDTO review : reviews) { %>
                <div class="review-item">
                    ...
                    <% if (isLoggedIn != null && isLoggedIn && review.getMemberId().equals(loggedInUser)) { %>
...
<div class="right">
    ...
    <div>
        <input type="text" name="check_in" value="2024-11-01">
        <input type="text" name="check_out" value="2024-11-05">
        <jsp:include page="information_cal.jsp">
            <jsp:param value="<%=roomIdxParam %>" name="room"/>
        </jsp:include>
    </div>
    <a href="/rooms/homesMap.jsp?room_idx=<%= room.getRoom_idx() %>" class="button map-link">지도 보기</a>

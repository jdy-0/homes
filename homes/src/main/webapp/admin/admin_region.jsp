...
<script>
function openrgUpdate() {
	window.open('/homes/admin/admin_region_update.jsp','adminrgUpdate','width=550,height=350');
}
</script>
</head>
<body>
	...
	<div class="sidebar">
	    ...
	    <nav>
	      	<ul id="ul_menu">
			    ...
			    <li><a href="/homes/admin/admin_region.jsp">지역 관리</a></li>		<!-- 웨 안됨?  -->
			...
			if(arr==null||arr.size()==0){
				...
				for(int i=0;i<arr.size();i++){
					...
					<tr>
						...
						<td><input type="button" name="<%=arr.get(i).getRegion_idx() %>" value="수정" class="rbutton" onclick="openrgUpdate();"></td>
